...
- (UIButton *)countryCodeButton
{
    if (!_countryCodeButton) {
        ...
        [_countryCodeButton setTitleColor:[UIColor ows_darkGreenColor]
...
- (UITextField *)phoneNumberTextField
{
    if (!_phoneNumberTextField) {
        ...
        _phoneNumberTextField.textColor = [UIColor ows_darkGreenColor];
...
- (void)updatePhoneNumberButtonEnabling
{
    ...
    [self.phoneNumberButton
        setBackgroundColorsWithUpColor:(isEnabled ? [UIColor ows_darkGreenColor] : [UIColor lightGrayColor])];
}
